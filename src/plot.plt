...
set xrange [0.0001:100];   set yrange [-43:62]
# set title ""
...
set xtics ("10^{-4}" 0.0001, "10^{-3}" 0.001, "10^{-2}" 0.01, "10^{-1}" 0.1, "1" 1, "10^1" 10, "10^2" 100)
set logscale x
set label "A" at 0.001, 55
set label "B" at 0.001, 33
set label "C" at 0.001, 3
set label "T = T_0 + ( T_i - T_0 ) / [ a b ( T_i - T_0 ) ln ( c t + 1 ) + 1 ]" at 0.5, 55
set label "T_i = INITIAL TEMP." at 0.5, 50
set label "T_0 = AMBIENT TEMP." at 0.5, 45.8
plot 'fig1_1.txt' using 1:2 with lines lw 1 dt 1 lt 8, \
    'fig1_2.txt' using 1:2 with lines lw 1 dt 1 lt 8, \
    'fig1_3.txt' using 1:2 with lines lw 1 dt 1 lt 8

set output 'fig2.pdf'
set terminal pdf enhanced font 'Cantarell Bold' fontscale 0.2 size 1.4, 2.0
set xrange [230:340];   set yrange [100:200000]
set y2range [2.325:2.825]
set xtics 230 340 20;   set mxtics 2
set ytics ("10^2" 100, "10^3" 1000, "10^4" 10000, "10^5" 100000)
set mytics 4
set xlabel "T ( K )";      set ylabel "e_s ( DYNE/CM^2 )"
set label "e_s = e_w ; T > 273 K" at 240, 150000 
set label "e_s = e_w + ( e_i - e_w ) ( 273 - T ) / 40 ; T < 273 K" at 240, 120000
set label "e_i = SAT. VAP. PRESSURE OVER ICE" at 240, 90000 
set label "e_w = SAT. VAP. PRESSURE \n            OVER WATER" at 240, 75000
unset logscale x; set logscale y
plot 'fig2_1.txt' using 1:2 with lines lw 1 dt 1 lt 8

set output 'fig3.pdf'
set terminal pdf enhanced font 'Cantarell Bold' fontscale 0.2 size 1.9, 1.3
set xrange [220:380];   set yrange [65:85]
set xtics 220 380 20;   set mxtics 2
set ytics 65 85 5;      set mytics 5
# set ytics nomirror
set y2tics ("2.4" 2.4, "2.5" 2.5, "2.6" 2.6, "2.7" 2.7, "2.8" 2.8)
set y2label "L(ERG/GM) x 10^{-10}"
set my2tics 4
set xlabel "T ( K )";      set ylabel "σ ( DYNE/CM )"
...
unset logscale y 
plot 'fig3_1.txt' using 1:2 with lines lw 1 dt 1 lt 8 axes x1y2, \
    'fig3_1.txt' using 1:3 with lines lw 1 dt 2 lt 8 axes x1y1

set output "fig4.pdf"
set terminal pdf enhanced font 'Cantarell Bold' fontscale 0.2 size 1.4, 2.0
set xrange [230:340];   set yrange [50000:200000000]
