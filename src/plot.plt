...
titleA1 = "Curve A: a = 5 x 10^{-4} cm^{-1} deg^{-1}, b = 66.7 cm^{-1}, "
titleA2 = "v_0 = 2000 cm sec^{-1} ;"
set label titleA1.titleA2 at 0.001, 100

titleB1 = "Curve B: a = 2 x 10^{-4} cm^{-1} deg^{-1}, b = 667 cm^{-1}, "
titleB2 = "v_0 = 200 cm sec^{-1} ;"
set label titleB1.titleB2 at 0.001, 90

titleC1 = "Curve C: a = 5 x 10^{-4} cm^{-1} deg^{-1}, b = 6670 cm^{-1}, "
titleC2 = "v_0 = 20 cm sec^{-1} . "
set label titleC1.titleC2 at 0.001, 80
